...
class TestGravity(unittest.TestCase):
    ...
    def test_Gravity(self):
        model = Gravity(self.f, self.o_var, self.d_var, self.dij, "exp", constant=True)
        np.testing.assert_allclose(
            model.params,
        ...
        np.testing.assert_allclose(
            model.cov_params,
            [
                [5.70906352e-03, -3.00814799e-04, -2.62650384e-04, -2.40317578e-06],
                [-3.00814799e-04, 2.67121974e-05, 3.21466745e-06, 1.16544737e-07],
                [-2.62650384e-04, 3.21466745e-06, 2.28600781e-05, 9.94368232e-08],
    ...
    def test_Production(self):
        model = Production(self.f, self.o, self.d_var, self.dij, "exp", constant=True)
        np.testing.assert_allclose(
            model.params,
            [
                -1.11700938,
    ...
    def test_Attraction(self):
        model = Production(self.f, self.d, self.o_var, self.dij, "exp", constant=True)
        np.testing.assert_allclose(
            model.params,
            [
                -0.88439723,
    ...
    def test_Doubly(self):
        model = Doubly(self.f, self.o, self.d, self.dij, "exp", constant=True)
        np.testing.assert_allclose(
            model.params,
            [
                6.20471518,
