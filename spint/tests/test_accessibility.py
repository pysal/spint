...
class AccessibilityTest(unittest.TestCase):
    ...
    def test_accessibility(self):
        ...
        flow['acc_uni'] = Accessibility(dest_nodes = flow['origin_ID'],  distances = flow['distances'], weights = flow['volume_in_unipartite'], masses = flow['dest_masses'], all_destinations=False)
