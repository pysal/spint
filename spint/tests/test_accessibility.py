    ...
    def test_accessibility(self):
        ...
        flow = flow.loc[
            ...
            [
                ...
                "destination_ID",
                "distances",
                "volume_in_unipartite",
                "dest_masses",
                "results_all=False",
            ],
        ]
        flow["acc_uni"] = Accessibility(
            dest_nodes=flow["origin_ID"],
            distances=flow["distances"],
            weights=flow["volume_in_unipartite"],
            masses=flow["dest_masses"],
